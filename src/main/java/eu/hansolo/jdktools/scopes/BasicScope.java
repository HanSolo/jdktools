...
public enum BasicScope implements Scope, Api {
    ...
    @Override public BasicScope getDefault() { return PUBLIC; }

    @Override public BasicScope getNotFound() { return BasicScope.NOT_FOUND; }

    @Override public BasicScope[] getAll() { return values(); }
